...
foreach ($d in @($stubCls, $appCls, $dexOut, $dist)) {
...
Write-Host '  {"key":"tvdy","name":"tvdy","type":3,"api":"csp_TvDy","searchable":1,"quickSearch":1,"filterable":1,"jar":"http://your-host/TvDy.jar"}'
